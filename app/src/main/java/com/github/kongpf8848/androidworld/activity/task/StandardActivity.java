...
public class StandardActivity extends BaseTaskActivity<ActivityTaskTemplateBinding> {
    ...
    protected void onCreateEnd(Bundle savedInstanceState) {
        ...
        btn_info.setText(LaunchMode.STANDARD.toString());
        btn_info.setOnClickListener(v->{
            this.startActivity(new Intent(this,TaskActivity.class));
        });
    }
