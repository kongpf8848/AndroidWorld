...
object Config {
    ...
    const val applicationId = "com.github.kongpf8848.androidworld"
...
object Versions {
    ...
    const val ANDROIDX_MATERIAL_VERSION = "1.11.0"
    ...
    const val ANDROIDX_CORE_VERSION = "1.8.0"
    ...
    const val ANDROIDX_ACTIVITY_VERSION = "1.4.0"
    const val ANDROIDX_FRAGMENT_VERSION = "1.4.1"
...
object BuildDependencies {
    ...
    const val immersionbarComponents =
        "com.gyf.immersionbar:immersionbar-components:${Versions.IMMERSIONBAR_VERSION}"
    const val immersionbarKtx =
        "com.gyf.immersionbar:immersionbar-ktx:${Versions.IMMERSIONBAR_VERSION}"
    ...
    const val ultraViewpager =
        "com.alibaba.android:ultraviewpager:${Versions.ULTRA_VIEWPAGER_VERSION}@aar"
    const val swipeBackLayout =
        "me.imid.swipebacklayout.lib:library:${Versions.SWIPEBACK_LAYOUT_VERSION}"
...
object AndroidX {
    ...
    const val legacyV13 =
        "androidx.legacy:legacy-support-v13:${Versions.ANDROIDX_LEGACY_V13_VERSION}"
    ...
    const val recyclerview =
        "androidx.recyclerview:recyclerview:${Versions.ANDROIDX_RECYCLERVIEW_VERSION}"
    ...
    const val coordinatorlayout =
        "androidx.coordinatorlayout:coordinatorlayout:${Versions.ANDROIDX_COORDINATORLAYOUT_VERSION}"
    const val databindingCommon =
        "androidx.databinding:databinding-common:${Versions.ANDROIDX_DATABINDING_VERSION}"
    const val databindingAdapters =
        "androidx.databinding:databinding-adapters:${Versions.ANDROIDX_DATABINDING_VERSION}"
    const val databindingRuntime =
        "androidx.databinding:databinding-runtime:${Versions.ANDROIDX_DATABINDING_VERSION}"
    ...
    const val lifecycleViewmodelSavedstate =
        "androidx.lifecycle:lifecycle-viewmodel-savedstate:${Versions.ANDROIDX_LIFECYCLE_VERSION}"
    const val lifecycleCompiler =
        "androidx.lifecycle:lifecycle-compiler:${Versions.ANDROIDX_LIFECYCLE_VERSION}"
    const val lifecycleCommonJava8 =
        "androidx.lifecycle:lifecycle-common-java8:${Versions.ANDROIDX_LIFECYCLE_VERSION}"
    const val lifecycleService =
        "androidx.lifecycle:lifecycle-service:${Versions.ANDROIDX_LIFECYCLE_VERSION}"
    const val lifecycleProcess =
        "androidx.lifecycle:lifecycle-process:${Versions.ANDROIDX_LIFECYCLE_VERSION}"
    const val lifecycleReactivestreamsKtx =
        "androidx.lifecycle:lifecycle-reactivestreams-ktx:${Versions.ANDROIDX_LIFECYCLE_VERSION}"
    const val arcCoreTesting =
        "androidx.arch.core:core-testing:${Versions.ANDROIDX_LIFECYCLE_ARCH_VERSION}"
